...
git clone https://github.com/aliothtrees/hardware_qcom_audio -b 13 hardware/qcom-caf/sm8250/audio
...
git clone https://github.com/aliothtrees/hardware_xiaomi-1 -b 13 hardware/xiaomi
git clone --depth=1 https://github.com/kdrag0n/proton-clang.git prebuilts/clang/host/linux-x86/proton-clang
git clone https://github.com/Roxor-007/vendor_xiaomi_alioth -b 13 vendor/xiaomi/alioth